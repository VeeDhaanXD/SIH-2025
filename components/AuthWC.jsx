...
import travelImg from "../src/img3.jpg" // add a travel-themed image in your assets
    ...
    >
      ...
      <div className="relative z-10 text-white px-8 py-6">
        <h2 className="text-2xl font-bold flex items-center gap-2">
          ...
          Welcome to Smart Travel Safety Dashboard 
        </h2>
        <p className="text-sm text-gray-200 mt-2">
          Manage all Users and respond to Emergencies !
        </p>
